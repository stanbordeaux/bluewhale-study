...
<body onload="initialize(); setActive()">
<div>
<h1>Latest Sightings</h1>
<h3>Welcome to the latest validated sightings of the blue whale. </h3>
<p>Whale positions are recorded by their latitude and longitude The map below shows the position of the last 4 sightings.  Because whales move about some whales may not be visible on the map. You can move the map about and zoom in or out to get a better view.</p>
</div>
