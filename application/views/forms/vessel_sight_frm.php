...
<style type="text/css">
    .sendit {     
        ...
        border: 0;     
        cursor: pointer;    
        background: url(<?=base_url(); ?>crir/crir/bws_but_submit.jpg) no-repeat 0 0;     
        text-indent: -9999px;     
        margin: 20px 0; 
    }
...
<div>
            ...
            <div>
                ...
                <h1 style="margin-left: 60px;">Vessel based sighting</h1>
                <p style="margin-left: 60px;">Whale sightings are recorded by storing the estimated latitude and longitude of the whale based on the position of the observer, the direction of the whales relative to the observation point and the estimated distance of the whale from the observer at the time of the sighting.<br /><br />
                 <p style="margin-left: 60px;">To record your sighting please enter your latitude and longitude at the time of the sighting.  You can provide coordinates either as decimal degrees or degrees, minutes, seconds.</p>
            </div>     
