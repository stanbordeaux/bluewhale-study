...
<form name="sighting_form"  id="sighting_form" action="<?=base_url(); ?>index.php/sightings/add_sighting" method="post">
        ...
        <fieldset><legend>Report a sighting</legend>
            <div>
            ...
            <div>
                ...
                <table>
                    <tr>
                    	<td>
                            <label for="reportType1">Vessel</label>
                            <input type="radio"  align="ABSMIDLE" name="reportType" id="reportType1" value="vessel" class="crirHiddenJS" checked="checked"/>
                        </td>
                    	<td>
                            <label for="reportType2">Land</label>
                            <input type="radio"  align="ABSMIDLE" name="reportType" id="reportType2" value="land" class="crirHiddenJS"/>
                        </td>
                    </tr>
                </table>
            </div>
            <div><input type="text" class="datepicker"/>
            	<h5 style="margin-top: 20px;" class="">What was the date and time of the whale sighting?</h5>
            	<label for = 'obDate' class="datepicker">Date</label>
            ...
            <div>
            	<h5 style="margin-top: 20px;" class="">For what length of time did you observe the whale?</h5>
                <table>
                    <tr>
                    	<td>
            ...
            <div>
                <h5 style="margin-top: 20px;" class="">From your position, in what direction were the whales?</h5>
                <table>
                    <tr>
                        <td>
            ...
            <div>
                <h5 style="margin-top: 20px;" class="">From your position, approximately how far away were the whales?</h5>
                <table>
                    <tr>
                        <td>
            ...
            <div>
            	<h5 style="margin-top: 20px;" class="">Were there any visual cues to alert you about the presence of a blue whale?</h5>
                <table>
                    <tr>
                        <td>
            ...
            <div>
            	<label for="numWhale"><h5 style="margin-top: 20px;" >How many whales did you see? <input type="text" name="numWhale" id="numWhale" value=""/></h5></label>
            </div>
            <div>
            	<h5 style="margin-top: 20px;" class="">What other identifying features did you see that led you to think you saw a blue whale?</h5>
                ...
                <label for="blowshape">Blow shape and size</label>
            ...
            <div>
                <h5 style="margin-top: 20px;" class="">How confident are you that it was a blue whale?</h5>
                <table>
                    <tr>
                        <td>
            ...
            <div>
            	<h5 style="margin-top: 20px;" class="">What were the whales doing?</h5>
            ...
            <div>
            	<h5 style="margin-top: 20px;" class="">Was there any other wildlife or discoloured water seen in the vicinity?</h5>
            ...
            <div>
            	<h5 style="margin-top: 20px;" class="">What was the weather like at the time?</h5>
                <table>
                    <tr>
                        <td>
            ...
            <div>
            	<h5 style="margin-top: 20px;" class="">Now, using the Beaufort Scale, what was the sea state at the time of the sighting?</h5>
                <table>
                    <tr>
                        <td>
            ...
            <div>
            	<h5 style="margin-top: 20px;" class="">What was the sea swell at the time of the sighting?</h5>
                <table>
                    <tr>
                        <td>
            ...
            <div>
                <h5 style="margin-top: 20px;" class="">We are interested in any other observations of the whale's behaviour.  You can provide a brief description of their behaviour here.</h5>
                <textarea id="behaviourDesc" cols="5" rows="5"  class="styled">        Comments:</textarea>
            </div>
