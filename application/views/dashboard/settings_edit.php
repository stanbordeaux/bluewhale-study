<script type="text/javascript" src="<?php echo base_url(); ?>assets/static/javascript/settings.js"></script>
<div class="post">
		...
		<div class="post_body">
			<p><?php echo lang('settings_description'); ?></p>
				...
				<tr>
					 <td colspan="2">
					 	<fieldset id="general_settings">
					 		...
					 		<table>
					 			<tr>
					 				<?php echo form_open('settings/get_settings'); ?>
				...
				<tr>
					<td colspan="2">
						<input type="submit" name="submit" value="Update Settings" class="styled" />
						<?php echo form_close(); ?>
					</td>
				</tr>
				</table>
