...
|   For Model Function:    $config['userTracking']['userIdentifier'] = array("model", "modelName", "modelFunction", "argument array");
|
...
$config['usertracking']['user_identifier'] = array("model", "user_model", "verify_user", array("username", "password"));
